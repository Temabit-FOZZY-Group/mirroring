...
class ConfigBuilderSuite extends AnyFunSuite {
  ...
  test("build should build config with correct parameters 2") {
    val args: Array[String] = Array(
      ...
      "jdbcUrl==jdbc:jtds:sqlserver://KVCEN15-SQLS005.officekiev.fozzy.lan;instance=heavy005;" +
        "domain=officekiev.fozzy.lan;useNTLMv2=true;databasename=ella;user=x;password=y;",
      "mode==overwrite",
      "write_partitioned==True",
